...
<html lang="en">
    ...
    <body>
        ...
        <div class="section">
            <div class="container">
                ...
                <h2 class=> Penalty List</h2>

                <div class="row">

                    <div class="col-12">

                        <div class="property-slider-wrap p-5">
  ...
  <div class="col-md-12 mt-5 text-center"><button class="btn btn-success" type="button"><a href="OwnerHistoryPenalty?id=${id}">Back</a></div>

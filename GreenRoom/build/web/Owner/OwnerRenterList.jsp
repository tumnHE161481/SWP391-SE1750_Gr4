                                    ...
                                    <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="padding: 12px; text-align: left; background-color: #f2f2f2;">Room Floor</th>
                                                <th style="padding: 12px; text-align: left; background-color: #f2f2f2;">Room Number</th>
                                                <th style="padding: 12px; text-align: left; background-color: #f2f2f2;">Room Size</th>
                                                <th style="padding: 12px; text-align: left; background-color: #f2f2f2;">Action</th>
                                            </tr>
                                        </thead>
                                        <c:forEach var="r" items="${OwRoomList}" varStatus="loop">
                                            <c:set var="id" value="${r.renterID}" />
                                            <tbody>
                                                <tr style="border-bottom: 1px solid #ddd; background-color: #f9f9f9;">
                                                    <td style="padding: 12px; text-align: left;">${loop.index + 1}</td>
                                                    <td style="padding: 12px; text-align: left;">${r.roomImg}</td>
                                                    <td style="padding: 12px; text-align: left;">${r.roomFloor}</td>
                                                    <td style="padding: 12px; text-align: left;">${r.roomNumber}</td>
                                                    <td style="padding: 12px; text-align: left;">${r.roomSize}</td>
                                                    <td style="padding: 12px; text-align: left;"><a href="owroomdetail?id=${id}">Detail</a></td>
                                                </tr>

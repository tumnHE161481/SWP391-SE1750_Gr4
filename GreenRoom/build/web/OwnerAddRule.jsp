        ...
        <style>
            ...
            @media (max-width: 768px) {
                ...
                .rule-list li {
                    ...
                    margin-bottom: 10px; /* Khoảng cách giữa các mục quy tắc */
                }
                ...
                <div class="container">
                    <div class="menu-bg-wrap">
                        <div class="site-navigation">
                            <a href="Homepage.html" class="logo m-0 float-start">Owner</a>

                ...
                <div class="table-responsive">
                    <form action="payment" id="frmCreateOrder" method="post">        
                        <div class="form-group">
                            ...
                            <input class="form-control w-25" readonly data-val="true" data-val-number="The field Amount must be a number." data-val-required="The Amount field is required." id="amount" name="amount" type="number" value="${cost}" />
                        </div>

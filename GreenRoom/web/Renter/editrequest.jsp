                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea value="${rq.description}" class="form-control" name="description" id="subject" placeholder="Enter Request Detail" style="height: 300px !important" required>${rq.description}</textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">

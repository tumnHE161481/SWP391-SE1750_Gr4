...
public class UserAuthorizationFilter implements Filter {
    ...
    private boolean hasPermission(String role, String url) {
        ...
        } else if (url.contains("seprofile") || url.contains("seeditprofile") || url.contains("selistcustomer")
                ||  url.contains("sehome") || url.contains("roomfeedetail")
                || url.contains("sesearch")) {
